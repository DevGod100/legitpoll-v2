...
export default function Login() {
  ...
  const signInWithReddit = async () => {
    try {
      // Reddit OAuth URL
      const clientId = process.env.NEXT_PUBLIC_REDDIT_CLIENT_ID || 'PeuCMSGvSVStpwbKnts3Q';
      ...
      console.log('Reddit OAuth URL:', redditAuthUrl); // Debug log
      ...
      console.error('Error with Reddit OAuth:', error);
    }
  };
